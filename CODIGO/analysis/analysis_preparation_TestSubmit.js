...
window.analysis_preparation_TestSubmit = [
  ...
  ['analysis_preparation', 'ADD', 2, 'Crear sin ID', {name_analysis_preparation: 'Analysis Method', description_analysis_preparation: 'Standard procedures for sample analysis testing protocols in laboratory environment with quality controls', bib_analysis_preparation: 'ISO 10381 2002 Sampling', file_analysis_preparation: 'analysis_method.doc'}, 'id_required'],
  ['analysis_preparation', 'ADD', 3, 'Crear sin nombre', {id_analysis_preparation: '457', description_analysis_preparation: 'Chemical analysis procedures for soil samples with detailed step by step instructions and safety precautions', bib_analysis_preparation: 'EPA Method 6200', file_analysis_preparation: 'chemical_prep.docx'}, 'name_required'],
  ['analysis_preparation', 'ADD', 4, 'Crear sin descripción', {id_analysis_preparation: '458', name_analysis_preparation: 'Physical Testing Method', bib_analysis_preparation: 'ISO 3094 2008 Procedures', file_analysis_preparation: 'physical_test.pdf'}, 'description_required'],
  ...
  ['analysis_preparation', 'ADD', 7, 'Crear todo vacío', {}, 'multiple_errors'],
  ...
  // ===== EDIT/EDIT TESTS =====
  ['analysis_preparation', 'EDIT', 9, 'Actualizar protocolo válido', {id_analysis_preparation: '456', name_analysis_preparation: 'EDITd Preparation'}, true],
  ['analysis_preparation', 'EDIT', 10, 'Actualizar con nombre vacío', {id_analysis_preparation: '456', name_analysis_preparation: ''}, 'name_required'],
  ['analysis_preparation', 'EDIT', 11, 'Actualizar ID inexistente', {id_analysis_preparation: '999', name_analysis_preparation: 'Nonexistent'}, 'id_not_found'],
  ['analysis_preparation', 'EDIT', 12, 'Actualizar descripción corta', {id_analysis_preparation: '456', description_analysis_preparation: 'Short desc'}, 'description_min_size_KO'],
  ['analysis_preparation', 'EDIT', 13, 'Actualizar solo referencia', {id_analysis_preparation: '457', bib_analysis_preparation: 'New Reference 2024'}, true],
  ['analysis_preparation', 'EDIT', 14, 'Actualizar archivo', {id_analysis_preparation: '458', file_analysis_preparation: 'EDITd_file.doc'}, true],
  ['analysis_preparation', 'EDIT', 15, 'Actualizar múltiples campos', {id_analysis_preparation: '459', name_analysis_preparation: 'EDITd Method', bib_analysis_preparation: 'EDITd Bibliography 2024'}, true],
  ['analysis_preparation', 'EDIT', 16, 'Editar permitir todos los campos', {id_analysis_preparation: '457', name_analysis_preparation: 'EDITd Protocol', description_analysis_preparation: 'EDITd procedures with comprehensive details and instructions', bib_analysis_preparation: 'EDITd ISO Reference 2024', file_analysis_preparation: 'EDITd_protocol.pdf'}, true],
